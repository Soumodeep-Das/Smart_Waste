...
const clientId = "BDIm7MhUm2PPE9KUQJ-gZ08A6ZI3-BFLzZYGi9ieC_mng0Ugu_ELX4gPzMlFRxv7JgzNSPAjRm_dj1BMVlFxavw";
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">Zero Waste, Big Impact</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
